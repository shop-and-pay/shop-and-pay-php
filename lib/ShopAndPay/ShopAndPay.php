<?php
/**
 * The Shop & Pay client API basic class file
...
class ShopAndPay
{
    ...
    /**
     * Generates an API object to use for the whole interaction with Shop & Pay.
     *
     * @param string $instance             The name of the Shop & Pay instance.
     * @param string $apiSecret            The API secret which can be found in the Shop & Pay administration.
     ...
     *
     * @return \ShopAndPay\Models\Response\Base[]|\ShopAndPay\Models\Response\Base
     * @throws \ShopAndPay\ShopAndPayException The model argument is missing or the method is not implemented
     */
    public function __call($method, $args)
    {
        ...
        if (empty($args)) {
            throw new \ShopAndPay\ShopAndPayException('Argument model is missing');
        }
        $model = current($args);
