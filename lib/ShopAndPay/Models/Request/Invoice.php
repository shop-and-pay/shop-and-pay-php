 ...
 */
class Invoice extends \ShopAndPay\Models\Base
{
     ...
     * can be found here: http://developers.shop-and-pay.com/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the Shop & Pay site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.shop-and-pay.com/docs/miscellaneous
     *
    ...
    {
        return new \ShopAndPay\Models\Response\Invoice();
    }
}
