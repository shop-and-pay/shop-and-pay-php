...
// optional: payment service provider(s) to use (see http://developers.shop-and-pay.com/docs/miscellaneous)
...
$gateway->addField($type = 'email', $value = 'max.muster@shop-and-pay.com');
