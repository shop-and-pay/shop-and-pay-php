...
$invoice = new \ShopAndPay\Models\Request\Invoice();
...
$invoice->setDescription('Thanks for using ShopAndPay to pay your order');

// administrative information, which provider to use (psp)
// psp #1 = ShopAndPay' test mode, see http://developers.shop-and-pay.com/docs/miscellaneous
//$invoice->setPsp([]);
...
// http://developers.shop-and-pay.com/docs/miscellaneous
...
try {
    $response = $shopandpay->create($invoice);
    var_dump($response);
